package cn.orag.loadmorelistview;
...
/**
 * Created by xianglong on 2016/9/23.
 * description:
 */
public class LoadMoreListView extends ListView {
    ...
    public void onNoMoreData() {
        isNoMoreData = true;
        updateFooterView(LayoutInflater.from(mContext).inflate(R.layout.list_no_more_item, null));
    }
